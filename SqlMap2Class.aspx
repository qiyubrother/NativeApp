<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SqlMap2Class.aspx.cs" Inherits="SqlMap2Class" %>
    ...
    <form id="form1" runat="server">
	 	<fieldset>
			<div class="form-group">
					...
					<input type="text" class="form-control" id="sql" runat="server" value="" />
					<label for="className">ClassName:</label>
					<input type="text" class="form-control" id="className" runat="server" value="" />
